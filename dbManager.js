...
module.exports = function(dbName) {
    ...
    con.query("CREATE DATABASE IF NOT EXISTS ?;".replace("?", dbName), function (err, result) {
        if (err) throw err;
    })
    ...
    module.createCourse = function (userid, courseid, name, colour) {
        return makeReq("INSERT INTO courses (userid, id, name, colour) VALUES (?)", [[userid, courseid, name, colour]]);
    }
    ...
    module.createAssignment = function (assignmentid, userid, name, course, due, done) {
        return makeReq("INSERT INTO assignments (id, userid, name, course, due, done) VALUES (?)", [[assignmentid, userid, name, course, due, done]]);
    }
    ...
    module.createUser = function (userid, username, hash) {
        return makeReq("INSERT INTO logins (userid, username, password) VALUES (?)", [[userid, username, hash]]);
    }
