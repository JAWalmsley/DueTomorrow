...
var AssignmentDB = /** @class */ (function (_super) {
    ...
    AssignmentDB.prototype.create = function (data) {
        return this.makeReq('INSERT INTO assignments (id, userid, courseid, name, due, done, weight, grade) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', [data.id, data.userid, data.courseid, data.name, data.due.toISOString(), data.done, data.weight, data.grade]);
    };
